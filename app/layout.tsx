...
export const metadata: Metadata = {
  ...
  description:
    "Turn any PDF or EPUB into focused, swipeable cards with on-device narration, ambient soundscapes, and accessible reading themes.",
  keywords: [
    "PDF reader app",
    "EPUB reader",
    "reading app",
  ...
  twitter: {
    ...
    title: "LeafTok — Your Books, Reimagined",
    description: "Turn any PDF or EPUB into focused, swipeable reading cards.",
