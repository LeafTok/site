...
export const steps: Step[] = [
  ...
  },
  {
    ...
    description: 'LeafTok breaks it into hundreds of optimized cards. Chapters, images, and formatting all survive.',
  },
  {
    numeral: '03',
    title: 'Swipe and absorb',
    description: 'Read like you scroll. Track your progress, build a streak, and actually finish the book this time.',
  },
];
...
export const homeFAQs: FAQItem[] = [
  ...
  },
  {
    ...
    answer:
      'The speed comes from bite-sized cards (100 to 350 characters), each sized to its content so your eye never loses the line. You read in focused bursts instead of fighting a wall of text. Built for comprehension, not skimming.',
  },
  {
