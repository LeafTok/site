  ...
  return (
    <Chapter
      ...
      heading={
        <>
          Press play and{' '}
          <span className="serif-italic text-primary">pocket the phone</span>.
        </>
      }
      lead={
        <>
          Sixteen Kokoro voices that actually sound human&mdash;British and
      ...
      side={
        <div className="relative w-[260px] lg:w-[300px]">
          ...
          <Image
            ...
            width={400}
            height={870}
            className="absolute -bottom-8 -right-12 w-[42%] rounded-[1.25rem] border border-paper/60 shadow-[0_18px_50px_-12px_rgba(26,22,18,0.3)]"
          />
        </div>
      }
    />
